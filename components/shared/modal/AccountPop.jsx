  ...
  return (
    ...
    >
      <div className="ap-header">
        <img src={aimg} />
        <p>
          {fname} <br></br> <small>{email} </small>
        </p>
      </div>
      <div className="ap-divider"></div>
      <Link href="/account/myorders">
        <a className="ap-anchor">
          <FileTextFilled style={{ fontSize: "20px" }} />
          <span style={{ marginLeft: "20px" }}>{t("OrderHistory")}</span>
        </a>
      </Link>
      <Link href="/account/dashboard">
        <a className="ap-anchor">
          <SettingFilled style={{ fontSize: "20px" }} />
          <span style={{ marginLeft: "20px" }}>{t("AccountSettings")}</span>
        </a>
      </Link>
      <div className="ap-divider"></div>
      <a
      ...
      >
        ...
        <span style={{ marginLeft: "20px" }}>{t("SignOut")}</span>
      </a>
    </Modal>
  );
}
