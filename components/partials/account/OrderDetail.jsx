                      ...
                      {orderLoading === false ? (
                        <div className="ps-block__content">
                          <div className="order-detail-header">
                            <h3>Order Details</h3>
                            <p>
                              Ordered on {orderDetailInfo.orderedDate} | Order#{" "}
                              {orderDetailInfo.orderProductPrefixId}
                            </p>
                            <a
                              href=""
                              onClick={(e) =>
                                getPdfData(e, orderDetailInfo.orderProductId)
                              }
                            >
                              {loadImg && (
                                <img
                          ...
                          <div className="order-detail-card diff-flex">
                              ...
                              <div className="left-order-image">
                                <img
                                  src={
                                    imageUrl +
                                    "?path=" +
                                    orderDetailInfo.containerName +
                                    "&name=" +
                                    orderDetailInfo.productImage
                                  }
                                />
                              </div>
                            ...
                            <div className="right-order-cart">
                              <button
                                onClick={(e) =>
                                  handleBuyAgain(e, orderDetailInfo.productSlug)
                                }
                              ...
                              <button
                                onClick={(e) =>
                                  handleProductReview(
                                    e,
                                    orderDetailInfo.orderProductId
                                  )
                                }
                                className={currentColor}
                              >
