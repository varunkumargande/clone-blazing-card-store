      ...
      <div className="sc-new-container">
        <div className="sc-left-container">
          ...
          <div className="sc-form-container">
            <div className="sc-scinput-container">
              ...
              />
              {submit && fnameError !== "" && (
                <span className="err-msg">{fnameError}</span>
              )}
            </div>
            <div className="sc-scinput-container">
              <input
            ...
            <div className="sc-scinput-container">
              ...
              />
              {submit && phoneError !== "" && (
                <span className="err-msg">{phoneError}</span>
              )}
            </div>
            <h2>
                ...
                addressData.map((address, index) => (
                  <div className="sc-ship-card flex" key={index}>
                    ...
                    <label className="sc-wh-container " for={address.addressId}>
                      <h4>
                        {address && address.addressType === 1 ? "Work" : "Home"}
                      </h4>
                      <p>
                        {address && address.address1}{" "}
                        {address && address.address2} {address && address.city}{" "}
            ...
            {submit && addresError !== "" && (
              <span className="err-msg">{addresError}</span>
            )}
          </div>
        </div>
        <div className="sc-right-checkout">
            ...
            <table>
              {cartItems && (
                <tr>
                    ...
                    <div className="rht-tb-img">
                      <img
                        src={
                          imageUrl +
                          "?path=" +
                          cartItems.productImage[0].containerName +
                          "&name=" +
                          cartItems.productImage[0].image +
                          "&width=60&height=60"
                        }
                      />
                    </div>
                  ...
                  <td className="sc-rht-td-data" style={{ color: "red" }}>
              ...
              <tr>
                <td className="sc-rht-ldc sc-rht-td-data " colSpan="2">
                  {t("checkouts.DeliveryCharges")}
                </td>
                <td className="sc-rht-rdc" colSpan="2">
                  {t("StockCheckout.Free")}
                </td>
              </tr>
              <tr>
                <td className="sc-rht-ldc sc-rht-td-data" colSpan="2">
                  {t("StockCheckout.Total")}
                </td>
                <td
          ...
          <div className="sc-submit-container">
            <button onClick={(e) => handleLoginSubmit(e)}>
              {t("checkouts.PlaceOrder")}
            </button>
          </div>
        </div>
      </div>
