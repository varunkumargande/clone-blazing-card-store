...
useEffect(()=>{
    if(sessionStorage.getItem("spurtUser")){
        if(JSON.parse(sessionStorage.getItem("spurtUser")).email){
            setEmail(JSON.parse(sessionStorage.getItem("spurtUser")).email)
        }
        if(JSON.parse(sessionStorage.getItem("spurtUser")).firstName){
            setFname(JSON.parse(sessionStorage.getItem("spurtUser")).firstName)
        }
        if(JSON.parse(sessionStorage.getItem("spurtUser")).lastName){
            setLname(JSON.parse(sessionStorage.getItem("spurtUser")).lastName)
        }
        
        if(JSON.parse(sessionStorage.getItem("spurtUser")).mobileNumber){
    ...
    const handleLoginSubmit = () => {
        if(addressCheck===1){
            ...
            sessionStorage.setItem("contact",JSON.stringify({fname:fname,lname:lname,email:email,address:address,city:city,number:num,postCode:postCode,productDetail:productDetail,total:amount}))
        }
        else{
                    ...
                    <div className="row">
                        <div className="col-xl-8 col-lg-8 col-md-12 col-sm-12">
                            <div className="ps-form__billing-info">
                                ...
                                {addressData.length!==0?<div className="form-group">
                                    <Form.Item
                                        label="First Name"
                                        name="First Name"
                                        rules={[
                                    ...
                                    <div className="ps-block__content">
                                        ...
                                        <figure>
                                            <figcaption>
                                                ...
                                                <small>${cartItems.quantityUpdated*cartItems.price}</small>
                                            </figcaption>
                                        </figure>
