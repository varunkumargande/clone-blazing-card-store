...
function BlazingRelatedProduct({ slugName, boxed }) {
          ...
          >
            ...
            <div className="ps-section__content">
              <Slider
                {...carouselStandard1}
                RelatedProduct
                infinite={relatedProduct.length < 7 ? false : true}
...
export default connect((state) => state.collection)(BlazingRelatedProduct);
