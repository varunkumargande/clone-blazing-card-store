...
import { postQuestionandAnswerPopApi } from '../../../api/product/QuestionAnswerApi';
import { useTranslation } from '../../../i18n';
// import {useTranslation} from '../../i18n'
function PostQuestionsPopup({showModal,setShowModal,productId}){
    const [question,setQuestion]=useState("")
    const [questionError,setQuestionError]=useState("")
    const [onblackcolors,setonblackcolors]=useState("")
...
export default PostQuestionsPopup;