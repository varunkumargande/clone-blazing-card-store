...
function LiveScheduleCategory({
  category,
  setLiveScheduleCategoryName,
      ...
      return (
        <>
          <div className="category-list">
            <button
              className={
                liveScheduleCategoryName === null ? "title active" : "title"
              }
          ...
          {category["categories"].map((res, index) => (
            <>
              <div className="category-list">
                <button
                  className={
                    liveScheduleCategoryName === res.name
                      ? "title active"
                      : "title"
                  }
                  onClick={() =>
                    handleActiveCategory(res.name, index, res.categoryId)
                  }
                >
                  {res.name}
                </button>
