        ...
        <div className="step-container">
            ...
            <div className="guidlines-step flex flex-start">
                ...
                <div className="ruls-wrap">
                    ...
                    <p>Please ship items within 2 business after a show or when an item is sold</p>
                </div>
            </div>
            <div className="guidlines-step flex flex-start">
                <div className="Check-icon"><IconCheck /></div>    
            ...
            <div className="guidlines-step flex flex-start">
                ...
                <div className="ruls-wrap">
                    ...
                    <p>Don’t sell fake items on Whatnot. If you’re unsure of an items authenticity, don’t sell it</p>
                </div>
            </div>
            <div className="guidlines-step flex flex-start">
                <div className="Check-icon"><IconCheck /></div>     
            ...
            <div className="guidlines-step flex flex-start">
                ...
                <div className="ruls-wrap">
                    <h4>Be nice</h4>
                    <p>Make sure you treat everyone with respect, and don’t harass or bully anyone in the community</p>
                </div>
            </div>
            <div className="guidlines-step flex flex-start">
                <div className="Check-icon"><IconCheck /></div>     
                <div className="ruls-wrap">
                    ...
                    <p>We've got more details on our policies here. In essence, just be honest and nice</p>
                </div>
            </div>
            <div className="button-wrapper">
                <button className="primary-btn">I agree to the Rules</button>
            </div>
        </div>
    );
}